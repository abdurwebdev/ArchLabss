...
const Footer = () => {
  ...
  return (
                ...
                <div className='mb-10 mt-10'>
                    ...
                    <div className='flex flex-col space-y-4 '>
                             <div className='flex items-center gap-4'>
                                 <FcMindMap/>
                                 <h1 className='text-[#8D8E93] font-normal text-sm'>	203 Fake St. Mountain View, San Francisco, California, USA</h1>
                             </div>
                             <div className='flex items-center gap-4'>
                                  <FcCellPhone/>
                                  <h1 className='text-[#8D8E93] font-normal text-sm'>	+2 392 3929 210</h1>
                             </div>
                             <div className='flex items-center gap-4'>
                                  <FcVoicemail/>
                                  <h1 className='text-[#8D8E93] font-normal text-sm'>	info@yourdomain.com</h1>
                            </div>
                    </div>
                </div>
            </div>
    ...
    <div className='m-auto mt-10'>
                     <h1 className='text-[#8D8E93] text-[15px] font-normal text-center'>Copyright ©2024 All rights reserved | This template is made with ❤ by Colorlib</h1>
            </div>
    </div>
  )
}
