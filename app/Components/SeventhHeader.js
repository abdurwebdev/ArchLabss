  ...
  return (
    <div className='relative '>
       ...
       <div className='w-96 h-60  absolute top-96 p-10 '>
        ...
        <Link href="/About" className='text-[#2a2a2a] no-underline text-xl  hover:transition-colors hover:text-[#96BB7C]'>HOME</Link>
        <AiFillHome/>
        <h1 className='text-xl text-[#2a2a2a] text-[15px] mt-2 '>CONTACT US</h1>
        <FcCellPhone/>
        </div>
